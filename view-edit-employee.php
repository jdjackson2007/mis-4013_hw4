        ...
        <div class="modal-body">
          ...
          <form method="POST" action="employee.php">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="EmployeeFirstName<?php echo $employee['employee_id']; ?>" name="Employee_FirstName" value="<?php echo $employee['employee_firstname']; ?>" required>
            </div>
            <div class="mb-3">
              <label for="EmployeeLastName<?php echo $employee['employee_id']; ?>" class="form-label">Last Name</label>
              <input type="text" class="form-control" id="EmployeeLastName<?php echo $employee['employee_id']; ?>" name="Employee_LastName" value="<?php echo $employee['employee_lastname']; ?>" required>
            </div>
            <div class="mb-3">
              <label for="EmployeeEmail<?php echo $employee['employee_id']; ?>" class="form-label">Email Address</label>
              <input type="email" class="form-control" id="EmployeeEmail<?php echo $employee['employee_id']; ?>" name="Employee_Email" value="<?php echo $employee['employee_email']; ?>" required>
            </div>
            <div class="mb-3">
              <label for="EmployeePhone<?php echo $employee['employee_id']; ?>" class="form-label">Phone Number</label>
              <input type="tel" class="form-control" id="EmployeePhone<?php echo $employee['employee_id']; ?>" name="Employee_Phone" value="<?php echo $employee['employee_phone']; ?>" required>
            </div>
            <div class="mb-3">
              <label for="EmployeeHireDate<?php echo $employee['employee_id']; ?>" class="form-label">Hire Date</label>
              <input type="date" class="form-control" id="EmployeeHireDate<?php echo $employee['employee_id']; ?>" name="Employee_HireDate" value="<?php echo $employee['employee_hiredate']; ?>" required>
            </div>
            <div class="mb-3">
              <label for="EmployeeJobTitle<?php echo $employee['employee_id']; ?>" class="form-label">Job Title</label>
              <input type="text" class="form-control" id="EmployeeJobTitle<?php echo $employee['employee_id']; ?>" name="Employee_JobTitle" value="<?php echo $employee['employee_jobtitle']; ?>" required>
            </div>
